...
export class BfgComponent {
  ...
  data = {
    ...
    resultBannerLast: "! 🦅 Whether you're playing a round of golf or just adding some excitement, our Birdie Fund Randomizer is here to bring a touch of randomness to your day. Feel the anticipation with every roll as you watch the fund grow, revealing your contribution. Let the game begin!",
