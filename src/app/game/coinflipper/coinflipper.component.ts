...
export class CoinflipperComponent {
  ...
  data = {
    ...
    resultBannerLast:
      " ! 🎉 Whether you're making a decision or just testing your luck, our coin flipper is here to add a dash of randomness to your day. Enjoy the thrill of chance with every click as you watch the coin dance through the air, landing on your selected side. Let the games begin!",
