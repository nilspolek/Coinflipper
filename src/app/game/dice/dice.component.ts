...
export class DiceComponent {
  ...
  data = {
    ...
    resultBannerLast:
      "! 🎲 Whether you're playing a game or just adding some excitement, our dice roller is here to bring a touch of randomness to your day. Feel the anticipation with every roll as you watch the die tumble across the table, revealing your number. Let the games begin",
