...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [NgbNavLinkBase, RouterLink],
  template: `
      ...
      <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" routerLink="/coinflipper" i18n>Coinflipper</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" routerLink="/bfg" i18n
            ...
            <li class="nav-item">
              <a class="nav-link" routerLink="data" href="data"
                >data-protection</a
              >
            </li>
          </ul>
